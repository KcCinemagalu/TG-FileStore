    ...
    if usr_cmd == "/start":
        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("OWNER", url="https://t.me/KingKc18")
                    ],
                    [
                    ...
                    [
                        InlineKeyboardButton("Movie Update", url="https://t.me/Kc_Films_2024"),
                        InlineKeyboardButton("Admin Support", url="https://t.me/KingKc18")
                    ]
                ]
            )
        )
...
async def main(bot: Client, message: Message):
    ...
    if message.chat.type == enums.ChatType.PRIVATE:
        ...
        if message.from_user.id in Config.BANNED_USERS:
            await message.reply_text("Sorry, You are banned!\n\nContact [Admin Support](https://t.me/KingKc18)",
                                     disable_web_page_preview=True)
            return
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [Admin Support](https://t.me/KingKc18).",
                        disable_web_page_preview=True
                    )
                    return
